...
namespace stu1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //計算血型百分比
            double presentA = (double)countA / (double)bloods.Length * 100;
            double presentB = (double)countB / (double)bloods.Length * 100;
            double presentAB = (double)countAB / (double)bloods.Length * 100;
            double presentO = (double)countO / (double)bloods.Length * 100;
            //計算身高平均
            double average = sum / count;
            double averageB = sumBoy / countBoy;
            double averageG = sumGirl / countGirl;

            Console.WriteLine("血型為A型的有："+countA+" 人，占 "+presentA+" %");
            Console.WriteLine("血型為B型的有：" + countB + " 人，占 " + presentB + " %");
            Console.WriteLine("血型為AB型的有：" + countAB + " 人，占 " + presentAB + " %");
            Console.WriteLine("血型為O型的有：" + countO + " 人，占 " + presentO + " %");
